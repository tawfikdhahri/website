        ...
        <div className="relative mt-12 space-y-16">
          {cv.experience.map((role, index) => (
            <article
              ...
              className="ml-8 rounded-xl border border-border/40 bg-background p-6 shadow-sm transition duration-200 ease-out hover:-translate-y-1 hover:border-primaryAccent hover:shadow-soft"
            >
